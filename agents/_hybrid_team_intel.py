...
# ============================================================
# Visible enemy snapshot (fog-of-war safe)
# ============================================================
...
class TeamIntel:
    ...
    def friendly_positions(self, *, alive_only: bool = True) -> Dict[int, GridPos]:
        return {e.id: e.pos for e in self.friendlies if e.alive or not alive_only}
    ...
    def move_away(
        ...
        *,
        ...
        return valid
    # ------------------------------------------------------------
    # Threat & pressure modeling (CORE ADDITION)
    # ------------------------------------------------------------
    ...
    def _enemy_is_grouped(self, enemy: VisibleEnemy, radius: float = 2.5) -> bool:
        """
        Pure geometric grouping check.
        """
        for other in self.visible_enemies:
    ...
    def enemy_threat_score(
        ...
        grouping_factor = 0.2 if self._enemy_is_grouped(enemy) else 0.0

        return min(1.0, distance_factor + fire_factor + grouping_factor)
